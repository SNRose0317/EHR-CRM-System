...
export const routes = {
    ...
    "Intravenous": {
        ...
        name: "Intravenous",
        code: "IV",
        description: "Injection into vein",
        applicableForms: ["Vial", "Solution"],
        humanReadable: "intravenously",
        fhirCode: "IV",
        requiresSpecialInstructions: true,
        specialInstructionsTemplate: "Inject {dose} {route} {frequency}."
    }
...
export function getVerb(doseForm, route) {
    const mapping = verbMappings.find(m => m.doseForm === doseForm && m.route === route);
...
//# sourceMappingURL=medication-data.js.map