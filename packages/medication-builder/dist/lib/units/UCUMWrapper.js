        ...
        try {
            ...
            if (err instanceof Error) {
                if (err.message.includes('Incompatible units')) {
                    throw ConversionErrors.impossibleConversion(from, to, 'Units have incompatible dimensions');
                }
                // Re-throw other errors
                throw ConversionErrors.invalidUnit(err.message.includes(normalizedFrom) ? from : to, err.message);
            }
            throw err;
        }
    }
...
//# sourceMappingURL=UCUMWrapper.js.map