...
export class TemplateDataBuilder {
     ...
     */
    static forTestosteroneCypionate(context) {
     ...
     */
    static formatTabletDose(value, unit) {
     ...
     */
    static formatTabletUnit(value, unit) {
        if (unit.toLowerCase() === 'tablet' || unit.toLowerCase() === 'tablets') {
     ...
     */
    static formatRoute(route, medicationType) {
        if (!route) {
...
//# sourceMappingURL=TemplateDataBuilder.js.map