 ...
 */
export function calculateDaysSupply(medication, dose) {
 ...
 */
function convertFrequencyToTiming(frequency) {
 ...
 */
function calculateDaysSupplyLegacy(medication, dose) {
 ...
 */
function areUnitsCompatible(doseUnit, packageUnit) {
 ...
 */
export function isDoseValid(medication, dose) {
 ...
 */
export function getDoseConstraintMessage(medication, dose) {
    const constraints = medication.dosageConstraints;
    if (!constraints)
        return null;
    if (constraints.minDose &&
