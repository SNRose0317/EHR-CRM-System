 ...
 */
export declare enum SpecificityLevel {
 ...
 */
export declare function compareSpecificity(a: IBaseStrategy, b: IBaseStrategy): number;
/**
 ...
 */
export declare function sortModifiersByPriority(modifiers: IModifierStrategy[]): IModifierStrategy[];
/**
 ...
 */
export declare function isValidStrategyComposition(obj: any): obj is StrategyComposition;
/**
