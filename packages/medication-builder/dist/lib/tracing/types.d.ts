 ...
 */
export type TraceEventType = 'conversion_start' | 'conversion_end' | 'conversion_step' | 'validation_start' | 'validation_end' | 'adapter_selection' | 'cache_hit' | 'cache_miss' | 'confidence_calculation' | 'error' | 'warning' | 'performance_metric';
/**
