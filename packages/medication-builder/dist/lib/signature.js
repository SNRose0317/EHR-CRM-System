import { doseForms, getFrequency, getRoute, getVerb } from '../constants/medication-data';
/**
 ...
 */
export function isMultiIngredient(medication) {
 ...
 */
export function getStrengthMode(doseForm) {
 ...
 */
export function getDenominatorUnit(doseForm) {
 ...
 */
export function getDispensingUnit(medication) {
 ...
 */
function formatTabletDose(value) {
    if (value < 0.25)
        return '1/4 tablet';
    if (value === 0.25)
        return '1/4 tablet';
    ...
    if (value === 1)
        return '1 tablet';
    if (value === 1.5)
        return '1 and 1/2 tablets';
    if (value === 2)
        return '2 tablets';
    if (value === 2.5)
        return '2 and 1/2 tablets';
 ...
 */
function formatDose(dose, medication) {
 ...
 */
export function generateSignature(medication, dose, routeName, frequencyName, specialInstructions) {
    // Get reference data
 ...
 */
export function validateDose(medication, dose) {
