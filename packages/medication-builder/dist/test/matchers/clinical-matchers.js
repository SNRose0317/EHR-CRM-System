 ...
 */
function normalizeDoseText(doseText) {
    return doseText
        .toLowerCase()
        .replace(/\s+/g, ' ')
        .replace(/,/g, '')
 ...
 */
function extractDose(signatureText) {
 ...
 */
function compareDoses(actual, expected) {
 ...
 */
function compareSignatures(actual, expected) {
    const differences = [];
 ...
 */
function toClinicallyEqual(received, expected) {
 ...
 */
function toHaveValidDoseFormat(received) {
 ...
 */
function toMatchSignatureStructure(received) {
 ...
 */
function toBeWithinDoseTolerance(received, expected, tolerance = 0.001) {
...
//# sourceMappingURL=clinical-matchers.js.map