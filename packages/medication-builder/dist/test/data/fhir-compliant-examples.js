 ...
 */
export const FHIR_INJECTABLE_MEDICATIONS = {
 ...
 */
export const FHIR_TABLET_MEDICATIONS = {
    atorvastatin: {
 ...
 */
export const FHIR_TOPICAL_MEDICATIONS = {
    hydrocortisone: {
 ...
 */
export const FHIR_LIQUID_MEDICATIONS = {
 ...
 */
export const FHIR_DAYS_SUPPLY_TEST_CASES = [
    {
        id: 'fhir-days-001',
 ...
 */
export const FHIR_EDGE_CASE_MEDICATIONS = {
    highDoseVitaminD: {
 ...
 */
export function getAllFHIRMedications() {
    const allMeds = [];
 ...
 */
export function validateFHIRPackaging(medication) {
    const errors = [];
...
//# sourceMappingURL=fhir-compliant-examples.js.map