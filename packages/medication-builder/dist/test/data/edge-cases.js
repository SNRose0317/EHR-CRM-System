 ...
 */
export const FRACTIONAL_DOSE_EDGE_CASES = [
    {
 ...
 */
export const UNIT_CONVERSION_EDGE_CASES = [
    {
 ...
 */
export const EXTREME_DOSE_EDGE_CASES = [
    {
        id: 'edge-extreme-001',
 ...
 */
export const MULTI_INGREDIENT_EDGE_CASES = [
    {
        id: 'edge-multi-001',
 ...
 */
export const ROUTE_FREQUENCY_EDGE_CASES = [
    {
        id: 'edge-route-001',
 ...
 */
export const RANGE_DOSING_EDGE_CASES = [
    {
        id: 'edge-range-001',
 ...
 */
export const SPECIAL_INSTRUCTION_EDGE_CASES = [
    {
        id: 'edge-instr-001',
 ...
 */
export const ADVANCED_BUILDER_EDGE_CASES = [
 ...
 */
export function getAllEdgeCases() {
    const allCases = [];
 ...
 */
export function getEdgeCasesByCategory(category) {
    return EDGE_CASES[category];
}
/**
 * Get error test cases (expected to fail)
 */
export function getErrorTestCases() {
    return getAllEdgeCases().filter(testCase => testCase.expected?.humanReadable?.startsWith('ERROR:'));
}
/**
 * Get valid edge cases (expected to pass)
 */
export function getValidEdgeCases() {
    return getAllEdgeCases().filter(testCase => !testCase.expected?.humanReadable?.startsWith('ERROR:'));
}
