 ...
 */
export const MULTI_INGREDIENT_CASES = [
 ...
 */
export const COMPLEX_PRN_CASES = [
 ...
 */
export const TAPERING_DOSE_CASES = [
 ...
 */
export function getAllComplexRegimenCases() {
    const allCases = [];
 ...
 */
export function getComplexRegimenCasesByCategory(category) {
    return COMPLEX_REGIMEN_CASES[category];
}
/**
 * Get total count of complex regimen test cases
 */
export function getComplexRegimenCaseCount() {
    return getAllComplexRegimenCases().length;
}
//# sourceMappingURL=complex-regimen-cases.js.map