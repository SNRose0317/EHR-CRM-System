 ...
 */
export const ENDOCRINOLOGY_SCENARIOS = {
 ...
 */
export const CARDIOLOGY_SCENARIOS = {
 ...
 */
export const DERMATOLOGY_SCENARIOS = {
 ...
 */
export const DIABETES_SCENARIOS = {
    insulinGlarginePens: {
 ...
 */
export function getAllRealWorldTestCases() {
    const allTestCases = [];
 ...
 */
export function getAllRealWorldMedications() {
...
//# sourceMappingURL=real-world-prescription-scenarios.js.map