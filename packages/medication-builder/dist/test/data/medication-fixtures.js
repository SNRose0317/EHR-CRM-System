 ...
 */
export function getMedicationsByDoseForm(doseForm) {
    return getAllMedications().filter(med => med.doseForm?.toLowerCase() === doseForm.toLowerCase());
}
/**
...
//# sourceMappingURL=medication-fixtures.js.map