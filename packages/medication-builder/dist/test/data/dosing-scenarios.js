 ...
 */
export const TABLET_DOSE_SCENARIOS = [
    // Whole tablets
 ...
 */
export const CAPSULE_DOSE_SCENARIOS = [
 ...
 */
export const LIQUID_VOLUME_SCENARIOS = [
    // Standard volumes
 ...
 */
export const WEIGHT_DOSE_SCENARIOS = [
    // Milligrams
 ...
 */
export const UNIT_DOSE_SCENARIOS = [
    // Insulin units
 ...
 */
export const TOPICAL_DOSE_SCENARIOS = [
    // Topiclick doses
 ...
 * Frequency scenarios
 */
export const FREQUENCY_SCENARIOS = [
    // Daily frequencies
 ...
 */
export const SPECIAL_INSTRUCTION_SCENARIOS = [
    // Timing instructions
 ...
 */
export function getDoseScenariosByCategory(category) {
    const allScenarios = [
 ...
 */
export function getRouteScenarios(doseForm) {
    return ROUTE_SCENARIOS.filter(route => route.applicableDoseForms.includes(doseForm.toLowerCase()));
}
/**
 * Get compatible special instructions for route
 */
export function getSpecialInstructions(route) {
    const routeCategory = ROUTE_SCENARIOS.find(r => r.route === route)?.category || 'other';
    return SPECIAL_INSTRUCTION_SCENARIOS.filter(instr => instr.applicableRoutes.includes(routeCategory));
}
/**
...
//# sourceMappingURL=dosing-scenarios.js.map