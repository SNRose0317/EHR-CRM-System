 ...
 */
export const QUARTER_TABLET_CASES = [
    {
 ...
 */
export const HALF_TABLET_CASES = [
    {
 ...
 * Requires QUARTER scoring type
 */
export const THREE_QUARTER_TABLET_CASES = [
    {
 ...
 */
export const MIXED_WHOLE_FRACTIONAL_CASES = [
    {
 ...
 */
export const UNSCORED_VALIDATION_CASES = [
    {
 ...
 */
export function getAllFractionalDosingCases() {
    const allCases = [];
 ...
 */
export function getFractionalDosingCasesByCategory(category) {
    return FRACTIONAL_DOSING_CASES[category];
}
/**
 * Get error test cases (expected to fail validation)
 */
export function getFractionalDosingErrorCases() {
    return UNSCORED_VALIDATION_CASES;
}
/**
 * Get valid fractional dosing cases (expected to pass)
 */
export function getValidFractionalDosingCases() {
    return getAllFractionalDosingCases().filter(testCase => !testCase.expected?.humanReadable?.startsWith('ERROR:'));
}
//# sourceMappingURL=fractional-dosing-cases.js.map