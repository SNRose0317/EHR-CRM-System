 ...
 */
export const REAL_WORLD_TABLET_EXAMPLES = [
    {
        id: 'real-tablet-001',
 ...
 */
export const REAL_WORLD_LIQUID_EXAMPLES = [
    {
        id: 'real-liquid-001',
 ...
 */
export const REAL_WORLD_INJECTABLE_EXAMPLES = [
    {
 ...
 */
export const REAL_WORLD_TOPICAL_EXAMPLES = [
    {
        id: 'real-topical-001',
 ...
 */
export const REAL_WORLD_MULTI_INGREDIENT_EXAMPLES = [
    {
        id: 'real-multi-001',
 ...
 */
export const REAL_WORLD_EDGE_CASES = [
    {
        id: 'real-edge-001',
 ...
 */
export const ADVANCED_REAL_WORLD_EXAMPLES = [
 ...
 */
export function getRealWorldExamplesByCategory(category) {
    return REAL_WORLD_EXAMPLES[category];
}
/**
 * Get examples for specific medication
 */
export function getRealWorldExamplesForMedication(medicationId) {
    return getAllRealWorldExamples().filter(example => example.input?.medication?.id === medicationId);
}
//# sourceMappingURL=real-world-examples.js.map