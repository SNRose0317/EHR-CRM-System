 ...
 */
export const NASAL_SPRAY_CASES = [
 ...
 */
export const OTHER_DEVICE_CASES = [
 ...
 */
export function getAllSpecialDispenserCases() {
    const allCases = [];
 ...
 */
export function getSpecialDispenserCasesByCategory(category) {
    return SPECIAL_DISPENSER_CASES[category];
}
/**
 * Get total count of special dispenser test cases
 */
export function getSpecialDispenserCaseCount() {
    return getAllSpecialDispenserCases().length;
}
//# sourceMappingURL=special-dispenser-cases.js.map