...
import { ScoringType } from '../types/MedicationProfile';
 ...
 */
export class SimpleTabletBuilder {
    ...
    validateRoute(route) {
        ...
        // Check tablet-specific route compatibility (only if dose form exists in constants)
        try {
...
//# sourceMappingURL=SimpleTabletBuilder.js.map