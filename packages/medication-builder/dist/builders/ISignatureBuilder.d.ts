 ...
 */
export declare function isValidDoseInput(dose: any): dose is DoseInput;
/**
 ...
 * @returns True if valid, false otherwise
 */
export declare function isValidTimingInput(timing: any): timing is TimingInput;
//# sourceMappingURL=ISignatureBuilder.d.ts.map