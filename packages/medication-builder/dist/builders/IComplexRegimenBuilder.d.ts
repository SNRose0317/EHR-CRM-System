 ...
 */
export declare function isValidDoseRangeInput(doseRange: unknown): doseRange is DoseRangeInput;
/**
 ...
 * @returns True if valid, false otherwise
 */
export declare function isValidFrequencyRangeInput(frequencyRange: unknown): frequencyRange is FrequencyRangeInput;
/**
 ...
 * @returns True if valid, false otherwise
 */
export declare function isValidTaperingPhase(phase: unknown): phase is TaperingPhase;
//# sourceMappingURL=IComplexRegimenBuilder.d.ts.map