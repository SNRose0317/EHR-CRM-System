 ...
 */
export class MultiIngredientBuilder extends SimpleLiquidBuilder {
    constructor(medication) {
        super(medication);
        // Store ingredient-specific information
        this.ingredientBreakdown = [];
        this.showIngredientBreakdown = true;
     ...
     */
    updateIngredientBreakdown(totalDose, doseUnit) {
        if (this.ingredientBreakdown.length <= 1)
            return;
     ...
     */
    findIngredientRatio(ingredientName) {
     ...
     */
    enhanceInstructionWithIngredients(instruction) {
     ...
     */
    validateMultiIngredientMedication() {
        const ingredients = this.medication.ingredient || [];
        if (ingredients.length <= 1) {
...
//# sourceMappingURL=MultiIngredientBuilder.js.map