...
import { isValidTaperingPhase } from './IComplexRegimenBuilder';
import { RelationshipType } from '../types/SignatureInstruction';
/**
 * Phase transition types for tapering schedules
 */
export var TaperingTransitionType;
(function (TaperingTransitionType) {
    /** Immediate transition to next phase */
    TaperingTransitionType["IMMEDIATE"] = "IMMEDIATE";
    /** Gradual reduction over time */
    TaperingTransitionType["GRADUAL"] = "GRADUAL";
    /** Conditional transition based on symptoms */
    TaperingTransitionType["CONDITIONAL"] = "CONDITIONAL";
    /** Provider-directed transition */
    TaperingTransitionType["PROVIDER_DIRECTED"] = "PROVIDER_DIRECTED";
})(TaperingTransitionType || (TaperingTransitionType = {}));
/**
 * Builder for tapering dose schedules and sequential instructions
 */
export class TaperingDoseBuilder extends SimpleTabletBuilder {
    ...
    buildSequentialInstructions(phases) {
        ...
        const enhancedPhases = phases.map((phase, index) => ({
            ...phase,
     ...
     */
    addMonitoringRequirement(requirement) {
     ...
     */
    addDiscontinuationWarning(warning) {
     ...
     */
    generatePhaseInstruction(phase) {
     ...
     */
    addTaperingInstructions(instructions) {
     ...
     */
    addTaperingContextToInstruction(instruction) {
        if (!this.taperingState.currentPhase)
            return;
     ...
     */
    formatTimingForExplanation(timing) {
...
//# sourceMappingURL=TaperingDoseBuilder.js.map